...
var webmname = window.webmname; // Change: Introduced 'webmname' variable to dynamically get the webm file path from the URL parameters.
...
var OmnitoneDemoContentData = {
  ...
  'fuerzaimprevista': {
    ...
    postGain: 2.5,
    urlSet: {
      'webm_1080p': webmname, // Change: Replaced the static URL with 'webmname' to dynamically load the webm video file based on URL parameter.
      'mp4_1080p': webmname,
    }
  }
};
